...
### 3.1 Graphics Surface Setup, Context Ownership, and Surface Lifecycle ([`SetupImpellerContext`](https://github.com/flutter/flutter/blob/4762dec4fc9072cd9269814ef36364f35a9a66dc/engine/src/flutter/shell/platform/android/platform_view_android.h#L128))
...
### 3.11 Task Runner Configuration, Thread Priorities, and Threading Modes
...
### 3.12 Platform Channel Messaging, Background Handlers, and Task Queues
...
### 3.13 Pointer Input Events, Application Locale, and Non-Linear Font Scaling
...
All C-API extensions specified in Section 3 (Sections 3.1 through 3.13) are implemented in [`embedder.h`](https://github.com/flutter/flutter/blob/4762dec4fc9072cd9269814ef36364f35a9a66dc/engine/src/flutter/shell/platform/embedder/embedder.h) and [`embedder.cc`](https://github.com/flutter/flutter/blob/4762dec4fc9072cd9269814ef36364f35a9a66dc/engine/src/flutter/shell/platform/embedder/embedder.cc).
...
Retiring legacy Hybrid Composition eliminates the need for dynamic thread leasing. Because neither HCPP nor TLHC requires thread leasing, Section 3.2 can be struck entirely from the proposed C-API expansion. This keeps [`embedder.h`](https://github.com/flutter/flutter/blob/4762dec4fc9072cd9269814ef36364f35a9a66dc/engine/src/flutter/shell/platform/embedder/embedder.h) lean, prevents leaking engine-internal threading assumptions into the public ABI, and eliminates thread-leasing state bugs.
...
Under the full migration plan (Section 8), CI presubmits must qualify the embedder across a 2x4x3 matrix:
